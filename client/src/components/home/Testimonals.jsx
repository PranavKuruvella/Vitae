      ...
      <div className="flex gap-2">
        ...
        <div className="flex flex-col">
          <div className="flex items-center gap-1">
            <p>{card.name}</p>
            <svg className="mt-0.5 fill-indigo-600" width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <>
      <div id='Testimonals' className='flex flex-col items-center my-10 scroll-mt-12'>
        ...
        <Title title="What Our Users Say" description="Real stories from people who landed their dream jobs with our AI-powered resume builder." />
      </div>
